...
const MODULE_MAP = [
  ...
  { prefix: 'src/analytics/youbora/',             module: 'youbora',                 risk: 'MEDIUM' },
...
const COVERAGE_MAP: Record<string, string[]> = {
  ...
  'analytics-ga4':           [],
  'analytics-reactions':     [],
  'youbora':                 ['tests/integration/youbora.spec.ts'],
  'analytics':               [],
...
const MODULE_KEYWORDS: Record<string, string[]> = {
  ...
  'analytics-streammetrics': ['streammetrics', 'StreamMetrics'],
  'youbora':                 ['youbora', 'Youbora', 'NPAW', 'npaw-plugin', 'youboranqs01', 'lma.npaw.com'],
