/**
 * debug-overlay.js — Overlay visual para debug en el Samsung Tizen TV
 *
 * Muestra en pantalla: estado del player, último evento, tecla presionada,
 * currentTime. Visible sobre el video sin necesidad de abrir Web Inspector.
 */
...
;(function() {
  ...
  overlay.innerHTML = [
    ...
    '<div id="ov-cdp" style="color:#ff0;margin-top:8px">sdb fwd tcp:9222</div>',
  ].join('')
